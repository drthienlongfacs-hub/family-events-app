...
import { MethodologyLogger } from './core/MethodologyLogger.js';
import fs from 'fs';
...
export async function enterpriseHarvest() {
    ...
    console.log(`📈 Log kiểm duyệt & Cải tiến hệ thống được lưu tại public/data/evolution_log.json`);
}

// Shell execution
if (process.argv[1] && process.argv[1].includes('scraper-github.js')) {
